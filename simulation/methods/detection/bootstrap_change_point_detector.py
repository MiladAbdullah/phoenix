...
class BootstrapChangePointDetector(DetectorMethod):
    boots: int
    ...
    def hierarchical_dampen_extremes_reordering(self, data_list):
        for data in data_list:
            try:
                ...
                self.log_error(f"something happened with {len(data)}")
    ...
    def compute_difference_series_from_data(self, column_data_old, column_data_new, aggregator, replicator) -> dict:
        ...
        return {
            ...
            "effect_size": difference / mean_old,
        }
    ...
    def compute_difference_one_per_rep(self, column_data_old, column_data_new):
        ...
        return self.compute_difference_series_from_data(
